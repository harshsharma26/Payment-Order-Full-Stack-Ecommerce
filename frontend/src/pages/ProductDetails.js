...
const ProductDetails = () => {
  ...
  const { fetchUserAddToCart } = useContext(Constext)
        ...
        <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
            ...
            {/* product Details */}
            {
              ...
              <div className='flex items-center gap-3 my-2'>
                    ...
                    <button className='border-2 border-red-600 rounded px-3 py-1 min-w-[120px] font-medium  bg-red-600 hover:text-red-600 hover:bg-white' onClick={(e)=>handleAddToCart(e,data?._id)}>Add To Cart</button>
              </div>
